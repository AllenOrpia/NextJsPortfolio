  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-90 transition cursor-pointer borderBlack dark:text-gray-950"
          href="/CV.pdf"
          download={true}
        >
          My Resume{" "}
